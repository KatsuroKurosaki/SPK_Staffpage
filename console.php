    ...
    <body>
        <?php define("_FILE",basename(__FILE__, '.php')); require 'navbar.php'; ?>
			<div class="container main">
				...
				<div class="row">
					<div class="col-md-4"><button class="btn btn-default" onclick="javascript:viewLogs();"><i class="fa fa-file-text-o fa-lg" aria-hidden="true"></i> Descargar registros</button></div>
				</div>
				<div>&nbsp;</div>
				<div>
